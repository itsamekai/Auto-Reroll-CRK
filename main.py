...
from handler.state import set_translate_widget, set_translator_language
...
def main():
    ...
    set_translate_widget("reroll_string", (notebook, 0))
    set_translate_widget("settings_string", (notebook, 1))
    set_translate_widget("instructions_string", (notebook, 2))
    ...
    def start_callback():
        on_start(widgets["roll_var"], widgets["line_var"], widgets["orange_var"], widgets["tainted_var"],
                 widgets["chopsticks_var"], widgets["delay_var"], log, tesseractAPI)
